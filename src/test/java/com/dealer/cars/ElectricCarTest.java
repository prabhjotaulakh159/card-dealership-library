...
public class ElectricCarTest {
    ...
    public void constructor_no_errors() {
        Car car = new ElectricCar("model", 2023, "orange", null, 3000, 500, "USA-23C");
    }

    @Test(expected = IllegalArgumentException.class)
    public void negative_voltage() {
        Car car = new ElectricCar("model", 2023, "orange", null, 3000, -1, "USA-23C");  
    }

    @Test(expected = IllegalArgumentException.class)
    public void zero_voltage() {
        Car car = new ElectricCar("model", 2023, "orange", null, 3000, 0, "USA-23C");  
    }

    @Test(expected = IllegalArgumentException.class)
    public void null_charger_type() {
        Car car = new ElectricCar("model", 2023, "orange", null, 3000, 0, null);  
    }

    @Test(expected = IllegalArgumentException.class)
    public void empty_charger_type() {
        Car car = new ElectricCar("model", 2023, "orange", null, 3000, 0, "");  
    }
    ...
    @Test
    public void isEqual() {
        Car car1 = new ElectricCar("model", 2023, "orange", null, 3000, 500, "USA-23C");
        Car car2 = new ElectricCar("model", 2023, "orange", null, 3000, 500, "USA-23C");
    ...
    public void notEqual() {
        Car car1 = new ElectricCar("model", 2023, "orange", null, 3000, 500, "USA-23C");
        Car car2 = new ElectricCar("model", 2023, "orange", null, 3000, 300, "USA-23C");
